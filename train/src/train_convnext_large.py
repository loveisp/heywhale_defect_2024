...
# 模型
def get_model(data):
    model = models.convnext_large('IMAGENET1K_V1')
    model.classifier[2] = nn.Linear(in_features=model.classifier[2].in_features, out_features=5, bias=True)
...
train_dl, valid_dl = get_ds(fold, 224, 32)
